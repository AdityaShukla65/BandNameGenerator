...
app.post("/submit", (req, res) => {
  const ran_adj=adj[Math.floor(Math.random()*adj.length)]
  const ran_noun=noun[Math.floor(Math.random()*noun.length)]
  res.render("index.ejs",{adjective:ran_adj,noun:ran_noun})
